        ...
        function processSamples(obj)
            if obj.oldProcedure
                ...
                if isempty(endRecordings)
                    ...
                    startRec = obj.Edf.RECORDINGS([obj.Edf.RECORDINGS.state].' == obj.RECORDING_STATES.START);
                    ...
                    eye_used = double([obj.Edf.RECORDINGS(recNr).eye]).';
                end
